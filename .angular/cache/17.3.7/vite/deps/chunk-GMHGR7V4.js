...
// node_modules/@spartan-ng/ui-core/fesm2022/spartan-ng-ui-core.mjs
...
function rxHostListener(event) {
  ...
  return fromEvent(inject(ElementRef).nativeElement, event).pipe(
    ...
    // Trigger CD like @HostListener would
    takeUntilDestroyed()
  );
}
function rxHostBinding(prop, stream) {
  stream.pipe(takeUntilDestroyed()).subscribe(process(inject(ElementRef).nativeElement, prop));
}
...
@angular/core/fesm2022/rxjs-interop.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-GMHGR7V4.js.map
