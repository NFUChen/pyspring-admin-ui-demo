...
// node_modules/@spartan-ng/ui-select-brain/fesm2022/spartan-ng-ui-select-brain.mjs
var _c0 = ["viewport"];
...
var _BrnSelectService = class _BrnSelectService {
  get selectTrigger() {
...
_BrnSelectService.ɵfac = function BrnSelectService_Factory(t) {
  return new (t || _BrnSelectService)();
};
_BrnSelectService.ɵprov = ɵɵdefineInjectable({
  token: _BrnSelectService,
  factory: _BrnSelectService.ɵfac
});
var BrnSelectService = _BrnSelectService;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BrnSelectService, [{
    type: Injectable
  }], () => [], null);
})();
var _BrnSelectOptionDirective = class _BrnSelectOptionDirective {
  constructor() {
    ...
    toObservable(this._selectService.value).pipe(takeUntilDestroyed()).subscribe((selectedValues) => {
...
_BrnSelectOptionDirective.ɵfac = function BrnSelectOptionDirective_Factory(t) {
  return new (t || _BrnSelectOptionDirective)();
};
_BrnSelectOptionDirective.ɵdir = ɵɵdefineDirective({
...
var BrnSelectOptionDirective = _BrnSelectOptionDirective;
(() => {
...
var _BrnSelectScrollDownDirective = class _BrnSelectScrollDownDirective {
  constructor() {
...
_BrnSelectScrollDownDirective.ɵfac = function BrnSelectScrollDownDirective_Factory(t) {
  return new (t || _BrnSelectScrollDownDirective)();
};
_BrnSelectScrollDownDirective.ɵdir = ɵɵdefineDirective({
...
var BrnSelectScrollDownDirective = _BrnSelectScrollDownDirective;
(() => {
...
var _BrnSelectScrollUpDirective = class _BrnSelectScrollUpDirective {
  constructor() {
    this._el = inject(ElementRef);
    this._selectContent = inject(BrnSelectContentComponent);
    this.endReached = new Subject();
...
_BrnSelectScrollUpDirective.ɵfac = function BrnSelectScrollUpDirective_Factory(t) {
  return new (t || _BrnSelectScrollUpDirective)();
};
_BrnSelectScrollUpDirective.ɵdir = ɵɵdefineDirective({
...
var BrnSelectScrollUpDirective = _BrnSelectScrollUpDirective;
(() => {
...
var _BrnSelectContentComponent = class _BrnSelectContentComponent {
  constructor() {
    this._el = inject(ElementRef);
...
_BrnSelectContentComponent.ɵfac = function BrnSelectContentComponent_Factory(t) {
  return new (t || _BrnSelectContentComponent)();
};
_BrnSelectContentComponent.ɵcmp = ɵɵdefineComponent({
...
var BrnSelectContentComponent = _BrnSelectContentComponent;
(() => {
...
var _BrnSelectGroupDirective = class _BrnSelectGroupDirective {
  constructor() {
    this.labelledBy = signal("");
  }
};
_BrnSelectGroupDirective.ɵfac = function BrnSelectGroupDirective_Factory(t) {
  return new (t || _BrnSelectGroupDirective)();
};
_BrnSelectGroupDirective.ɵdir = ɵɵdefineDirective({
...
var BrnSelectGroupDirective = _BrnSelectGroupDirective;
(() => {
...
var _BrnSelectLabelDirective = class _BrnSelectLabelDirective {
  constructor() {
...
_BrnSelectLabelDirective.ɵfac = function BrnSelectLabelDirective_Factory(t) {
  return new (t || _BrnSelectLabelDirective)();
};
_BrnSelectLabelDirective.ɵdir = ɵɵdefineDirective({
  type: _BrnSelectLabelDirective,
  selectors: [["", "brnSelectLabel", ""]],
  standalone: true,
  features: [ɵɵHostDirectivesFeature([BrnLabelDirective])]
});
var BrnSelectLabelDirective = _BrnSelectLabelDirective;
(() => {
...
var _BrnSelectTriggerDirective = class _BrnSelectTriggerDirective {
  constructor() {
...
_BrnSelectTriggerDirective.ɵfac = function BrnSelectTriggerDirective_Factory(t) {
  return new (t || _BrnSelectTriggerDirective)();
};
_BrnSelectTriggerDirective.ɵdir = ɵɵdefineDirective({
...
var BrnSelectTriggerDirective = _BrnSelectTriggerDirective;
(() => {
...
var _BrnSelectValueComponent = class _BrnSelectValueComponent {
  constructor() {
    this._selectService = inject(BrnSelectService);
...
_BrnSelectValueComponent.ɵfac = function BrnSelectValueComponent_Factory(t) {
  return new (t || _BrnSelectValueComponent)();
};
_BrnSelectValueComponent.ɵcmp = ɵɵdefineComponent({
...
var BrnSelectValueComponent = _BrnSelectValueComponent;
(() => {
...
var nextId2 = 0;
var _BrnSelectComponent = class _BrnSelectComponent {
  ...
  constructor() {
    ...
    toObservable(this._selectService.value).pipe(takeUntilDestroyed(), skip(1)).subscribe((value) => this._onChange(value || null));
    toObservable(this.dir).pipe(takeUntilDestroyed()).subscribe(() => this._selectService.state.update((state) => __spreadProps(__spreadValues({}, state), {
      dir: this.dir()
    })));
  }
  ngAfterContentInit() {
...
_BrnSelectComponent.ɵfac = function BrnSelectComponent_Factory(t) {
  return new (t || _BrnSelectComponent)();
};
_BrnSelectComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    closeDelay: [InputFlags.SignalBased, "closeDelay"]
  },
  outputs: {
    openedChange: "openedChange"
  },
  standalone: true,
  features: [ɵɵProvidersFeature([BrnSelectService, CdkListbox, provideExposedSideProviderExisting(() => _BrnSelectComponent), provideExposesStateProviderExisting(() => _BrnSelectComponent)]), ɵɵStandaloneFeature],
  ...
  template: function BrnSelectComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      ɵɵconditional(0, !ctx.labelProvided() && ctx._placeholder() ? 0 : 1);
      ɵɵadvance(5);
...
var BrnSelectComponent = _BrnSelectComponent;
(() => {
...
var _BrnSelectModule = class _BrnSelectModule {
};
_BrnSelectModule.ɵfac = function BrnSelectModule_Factory(t) {
  return new (t || _BrnSelectModule)();
};
_BrnSelectModule.ɵmod = ɵɵdefineNgModule({
...
_BrnSelectModule.ɵinj = ɵɵdefineInjector({
  imports: [BrnSelectComponent]
});
var BrnSelectModule = _BrnSelectModule;
(() => {
