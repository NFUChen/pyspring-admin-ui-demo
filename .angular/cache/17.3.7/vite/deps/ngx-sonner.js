...
function ToastComponent_Conditional_4_Conditional_0_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    let tmp_4_0;
    const ctx_r2 = ɵɵnextContext(3);
    ɵɵconditional(0, (tmp_4_0 = ctx_r2.toastType()) === "success" ? 0 : tmp_4_0 === "error" ? 1 : tmp_4_0 === "warning" ? 2 : tmp_4_0 === "info" ? 3 : -1);
  }
}
function ToastComponent_Conditional_4_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵconditional(1, ctx_r2.toast().promise || ctx_r2.toastType() === "loading" && !ctx_r2.toast().icon ? 1 : -1);
    ɵɵadvance();
    ɵɵconditional(2, ctx_r2.toast().icon ? 2 : 3);
  }
}
...
function ToastComponent_Conditional_4_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵpipe(2, "isString");
    ɵɵtemplate(3, ToastComponent_Conditional_4_Conditional_2_Conditional_3_Template, 2, 4);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    let tmp_4_0;
    ...
    ɵɵadvance();
    ɵɵconditional(1, ɵɵpipeBind1(2, 3, ctx) ? 1 : 3);
  }
}
...
function ToastComponent_Conditional_4_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵpipe(2, "isString");
    ɵɵtemplate(3, ToastComponent_Conditional_4_Conditional_3_Conditional_3_Template, 2, 4);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    let tmp_4_0;
...
function ToastComponent_Conditional_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    let tmp_6_0;
    const ctx_r2 = ɵɵnextContext();
    ɵɵconditional(0, ctx_r2.toastType() !== "default" || ctx_r2.toast().icon || ctx_r2.toast().promise ? 0 : -1);
    ɵɵadvance(2);
    ɵɵconditional(2, (tmp_3_0 = ctx_r2.toast().title) ? 2 : -1, tmp_3_0);
    ɵɵadvance();
    ɵɵconditional(3, (tmp_4_0 = ctx_r2.toast().description) ? 3 : -1, tmp_4_0);
    ɵɵadvance();
    ɵɵconditional(4, (tmp_5_0 = ctx_r2.toast().cancel) ? 4 : -1, tmp_5_0);
    ɵɵadvance();
    ɵɵconditional(5, (tmp_6_0 = ctx_r2.toast().action) ? 5 : -1, tmp_6_0);
  }
}
var _c3 = ["listRef"];
...
function NgxSonnerToaster_Conditional_0_For_2_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵelement(1, "ngx-sonner-loader", 6)(2, "ngx-sonner-icon", 7)(3, "ngx-sonner-icon", 8)(4, "ngx-sonner-icon", 9)(5, "ngx-sonner-icon", 10);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    let tmp_22_0;
    ...
    ɵɵproperty("index", $index_r4)("toast", toast_r3)("invert", ctx_r1.invert())("visibleToasts", ctx_r1.visibleToasts())("closeButton", ctx_r1.closeButton())("interacting", ctx_r1.interacting())("position", ctx_r1.position())("expandByDefault", ctx_r1.expand())("expanded", ctx_r1.expanded())("actionButtonStyle", ctx_r1.toastOptions().actionButtonStyle)("cancelButtonStyle", ctx_r1.toastOptions().cancelButtonStyle)("descriptionClass", (tmp_34_0 = ctx_r1.toastOptions().descriptionClass) !== null && tmp_34_0 !== void 0 ? tmp_34_0 : "")("classes", (tmp_35_0 = ctx_r1.toastOptions().classes) !== null && tmp_35_0 !== void 0 ? tmp_35_0 : ɵɵpureFunction0(18, _c4))("duration", (tmp_36_0 = ctx_r1.toastOptions().duration) !== null && tmp_36_0 !== void 0 ? tmp_36_0 : ctx_r1.duration())("unstyled", (tmp_37_0 = ctx_r1.toastOptions().unstyled) !== null && tmp_37_0 !== void 0 ? tmp_37_0 : false);
    ɵɵadvance();
...
function NgxSonnerToaster_Conditional_0_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    })("pointerdown", function NgxSonnerToaster_Conditional_0_For_2_Template_ol_pointerdown_0_listener() {
      ɵɵrestoreView(_r1);
      const ctx_r1 = ɵɵnextContext(2);
      return ɵɵresetView(ctx_r1.interacting.set(true));
    ...
    ɵɵrepeaterCreate(2, NgxSonnerToaster_Conditional_0_For_2_For_3_Template, 6, 19, "ngx-sonner-toast", 4, _forTrack0);
    ɵɵpipe(4, "toastPosition");
    ɵɵelementEnd();
  }
  if (rf & 2) {
    ...
    if (alreadyExists) {
      toasts.update((prev) => prev.map((toast2) => {
        if (toast2.id === id) {
          ...
          return __spreadProps(__spreadValues({}, toast2), {
            updated: false
          });
      }));
    } else {
...
_LoaderComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    isVisible: [InputFlags.SignalBased, "isVisible"]
  },
  standalone: true,
  features: [ɵɵStandaloneFeature],
  decls: 4,
...
var _ToastPositionPipe = class _ToastPositionPipe {
  transform(toasts, index, position) {
    return toasts.filter((toast2) => !toast2.position && index === 0 || toast2.position === position);
  }
};
_ToastPositionPipe.ɵfac = function ToastPositionPipe_Factory(t) {
  return new (t || _ToastPositionPipe)();
};
_ToastPositionPipe.ɵpipe = ɵɵdefinePipe({
  name: "toastPosition",
  type: _ToastPositionPipe,
  pure: true,
  standalone: true
});
var ToastPositionPipe = _ToastPositionPipe;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ToastPositionPipe, [{
    type: Pipe,
    args: [{
      name: "toastPosition",
      standalone: true
...
_AsComponentPipe.ɵfac = function AsComponentPipe_Factory(t) {
  return new (t || _AsComponentPipe)();
};
...
_IsStringPipe.ɵfac = function IsStringPipe_Factory(t) {
  return new (t || _IsStringPipe)();
};
...
var _ToastComponent = class _ToastComponent {
  constructor() {
    ...
    this.duration = input(TOAST_LIFETIME$1);
    ...
    effect(() => {
      ...
      untracked(() => this.offset.set(heightIndex * GAP$1 + toastsHeightBefore));
    });
    effect(() => {
      if (this.toast().updated) {
        clearTimeout(this.timeoutId);
        this.remainingTime = this.toast().duration ?? this.duration() ?? TOAST_LIFETIME$1;
        this.startTimer();
      }
    });
    effect((onCleanup) => {
...
_ToastComponent.ɵcmp = ɵɵdefineComponent({
  ...
  viewQuery: function ToastComponent_Query(rf, ctx) {
    ...
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.toastRef = _t.first);
    }
  },
  inputs: {
    toast: [InputFlags.SignalBased, "toast"],
    index: [InputFlags.SignalBased, "index"],
    expanded: [InputFlags.SignalBased, "expanded"],
    _invert: [InputFlags.SignalBased, "invert", "_invert"],
    position: [InputFlags.SignalBased, "position"],
    visibleToasts: [InputFlags.SignalBased, "visibleToasts"],
    expandByDefault: [InputFlags.SignalBased, "expandByDefault"],
    closeButton: [InputFlags.SignalBased, "closeButton"],
    interacting: [InputFlags.SignalBased, "interacting"],
    cancelButtonStyle: [InputFlags.SignalBased, "cancelButtonStyle"],
    actionButtonStyle: [InputFlags.SignalBased, "actionButtonStyle"],
    duration: [InputFlags.SignalBased, "duration"],
    descriptionClass: [InputFlags.SignalBased, "descriptionClass"],
    _classes: [InputFlags.SignalBased, "classes", "_classes"],
    unstyled: [InputFlags.SignalBased, "unstyled"],
    _class: [InputFlags.SignalBased, "class", "_class"],
    _style: [InputFlags.SignalBased, "style", "_style"]
  },
  standalone: true,
  features: [ɵɵStandaloneFeature],
...
var _NgxSonnerToaster = class _NgxSonnerToaster {
  constructor() {
    ...
    this.handleKeydown = (event) => {
      ...
      if (event.code === "Escape" && (document.activeElement === this.listRef.nativeElement || this.listRef.nativeElement?.contains(document.activeElement))) {
...
_NgxSonnerToaster.ɵfac = function NgxSonnerToaster_Factory(t) {
  return new (t || _NgxSonnerToaster)();
};
_NgxSonnerToaster.ɵcmp = ɵɵdefineComponent({
  ...
  viewQuery: function NgxSonnerToaster_Query(rf, ctx) {
    ...
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.listRef = _t.first);
    }
  },
  inputs: {
    invert: [InputFlags.SignalBased, "invert"],
    theme: [InputFlags.SignalBased, "theme"],
    position: [InputFlags.SignalBased, "position"],
    hotKey: [InputFlags.SignalBased, "hotKey"],
    richColors: [InputFlags.SignalBased, "richColors"],
    expand: [InputFlags.SignalBased, "expand"],
    duration: [InputFlags.SignalBased, "duration"],
    visibleToasts: [InputFlags.SignalBased, "visibleToasts"],
    closeButton: [InputFlags.SignalBased, "closeButton"],
    toastOptions: [InputFlags.SignalBased, "toastOptions"],
    offset: [InputFlags.SignalBased, "offset"],
    dir: [InputFlags.SignalBased, "dir"],
    _class: [InputFlags.SignalBased, "class", "_class"],
    _style: [InputFlags.SignalBased, "style", "_style"]
  },
  standalone: true,
...
var SwipeStateTypes;
(function(SwipeStateTypes2) {
  SwipeStateTypes2["SwipedOut"] = "SwipedOut";
  SwipeStateTypes2["SwipedBack"] = "SwipedBack";
  SwipeStateTypes2["NotSwiped"] = "NotSwiped";
