...
// node_modules/@spartan-ng/ui-table-brain/fesm2022/spartan-ng-ui-table-brain.mjs
var _c02 = [[["", "brnHeaderDef", ""]], [["", "brnCellDef", ""]], [["", "brnFooterDef", ""]]];
var _c12 = ["[brnHeaderDef]", "[brnCellDef]", "[brnFooterDef]"];
var _c2 = ["cdkTable"];
var _c3 = ["*", [["", "brnNoDataRow", ""]]];
var _c4 = ["*", "[brnNoDataRow]"];
function BrnTableComponent_cdk_header_row_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelement(0, "cdk-header-row");
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
    ɵɵclassMap(ctx_r1.headerRowClasses);
  }
}
function BrnTableComponent_Conditional_4_cdk_row_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "cdk-row", 6);
    ɵɵlistener("keydown.enter", function BrnTableComponent_Conditional_4_cdk_row_0_Template_cdk_row_keydown_enter_0_listener() {
      const row_r4 = ɵɵrestoreView(_r3).$implicit;
      const ctx_r1 = ɵɵnextContext(2);
      return ɵɵresetView(!!ctx_r1.onRowClick && ctx_r1.onRowClick(row_r4));
    })("click", function BrnTableComponent_Conditional_4_cdk_row_0_Template_cdk_row_click_0_listener() {
      const row_r4 = ɵɵrestoreView(_r3).$implicit;
      const ctx_r1 = ɵɵnextContext(2);
      return ɵɵresetView(!!ctx_r1.onRowClick && ctx_r1.onRowClick(row_r4));
    });
  ...
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext(2);
    ɵɵclassMap(ctx_r1.bodyRowClasses);
    ɵɵclassProp("row-interactive", !!ctx_r1.onRowClick);
    ɵɵproperty("tabindex", !!ctx_r1.onRowClick ? 0 : -1);
    ɵɵattribute("role", !!ctx_r1.onRowClick ? "button" : "row");
  }
}
function BrnTableComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, BrnTableComponent_Conditional_4_cdk_row_0_Template, 1, 6, "cdk-row", 5);
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
    ɵɵproperty("cdkRowDefColumns", ctx_r1.displayedColumns);
  }
}
function BrnTableComponent_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵprojection(0, 1);
  }
}
var _BrnCellDefDirective = class _BrnCellDefDirective extends CdkCellDef {
  constructor(template) {
    super(template);
    this.template = template;
  }
};
_BrnCellDefDirective.ɵfac = function BrnCellDefDirective_Factory(t) {
  return new (t || _BrnCellDefDirective)(ɵɵdirectiveInject(TemplateRef));
};
_BrnCellDefDirective.ɵdir = ɵɵdefineDirective({
  type: _BrnCellDefDirective,
  selectors: [["", "brnCellDef", ""]],
  exportAs: ["brnCellDef"],
  standalone: true,
  features: [ɵɵInheritDefinitionFeature]
});
var BrnCellDefDirective = _BrnCellDefDirective;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BrnCellDefDirective, [{
    type: Directive,
    args: [{
      standalone: true,
      selector: "[brnCellDef]",
...
var _BrnFooterDefDirective = class _BrnFooterDefDirective extends CdkFooterCellDef {
  constructor(template) {
    super(template);
    this.template = template;
  }
};
_BrnFooterDefDirective.ɵfac = function BrnFooterDefDirective_Factory(t) {
  return new (t || _BrnFooterDefDirective)(ɵɵdirectiveInject(TemplateRef));
};
_BrnFooterDefDirective.ɵdir = ɵɵdefineDirective({
  type: _BrnFooterDefDirective,
  selectors: [["", "brnFooterDef", ""]],
  exportAs: ["brnFooterDef"],
  standalone: true,
  features: [ɵɵInheritDefinitionFeature]
});
var BrnFooterDefDirective = _BrnFooterDefDirective;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BrnFooterDefDirective, [{
    type: Directive,
    args: [{
      standalone: true,
...
var _BrnHeaderDefDirective = class _BrnHeaderDefDirective extends CdkHeaderCellDef {
  constructor(template) {
    super(template);
    this.template = template;
  }
};
_BrnHeaderDefDirective.ɵfac = function BrnHeaderDefDirective_Factory(t) {
  return new (t || _BrnHeaderDefDirective)(ɵɵdirectiveInject(TemplateRef));
};
_BrnHeaderDefDirective.ɵdir = ɵɵdefineDirective({
  type: _BrnHeaderDefDirective,
  selectors: [["", "brnHeaderDef", ""]],
  exportAs: ["brnHeaderDef"],
  standalone: true,
  features: [ɵɵInheritDefinitionFeature]
});
var BrnHeaderDefDirective = _BrnHeaderDefDirective;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BrnHeaderDefDirective, [{
    type: Directive,
    args: [{
      standalone: true,
...
var _BrnColumnDefComponent = class _BrnColumnDefComponent {
  constructor() {
    this._name = "";
    this.class = input("");
  }
...
_BrnColumnDefComponent.ɵfac = function BrnColumnDefComponent_Factory(t) {
  return new (t || _BrnColumnDefComponent)();
};
_BrnColumnDefComponent.ɵcmp = ɵɵdefineComponent({
  type: _BrnColumnDefComponent,
  selectors: [["brn-column-def"]],
  contentQueries: function BrnColumnDefComponent_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ɵɵcontentQuery(dirIndex, BrnCellDefDirective, 7);
      ɵɵcontentQuery(dirIndex, BrnFooterDefDirective, 7);
      ɵɵcontentQuery(dirIndex, BrnHeaderDefDirective, 7);
    }
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx._cellDef = _t.first);
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx._footerCellDef = _t.first);
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx._headerCellDef = _t.first);
    }
  },
  viewQuery: function BrnColumnDefComponent_Query(rf, ctx) {
    if (rf & 1) {
      ɵɵviewQuery(CdkColumnDef, 7);
    }
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx._columnDef = _t.first);
    }
  },
  inputs: {
    name: "name",
    class: [InputFlags.SignalBased, "class"]
  },
  standalone: true,
  features: [ɵɵStandaloneFeature],
  ...
  decls: 4,
  vars: 1,
  consts: [[3, "cdkColumnDef"]],
  template: function BrnColumnDefComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      ɵɵproperty("cdkColumnDef", ctx.name);
    }
  },
  dependencies: [CdkTableModule, CdkColumnDef],
  encapsulation: 2,
  changeDetection: 0
});
var BrnColumnDefComponent = _BrnColumnDefComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BrnColumnDefComponent, [{
    type: Component,
    args: [{
    ...
    _cellDef: [{
      type: ContentChild,
      args: [BrnCellDefDirective, {
        static: true
      }]
    }],
    _footerCellDef: [{
      type: ContentChild,
      args: [BrnFooterDefDirective, {
        static: true
      }]
    }],
    _headerCellDef: [{
      type: ContentChild,
      args: [BrnHeaderDefDirective, {
        static: true
      }]
    }]
  });
})();
var _BrnPaginatorDirective = class _BrnPaginatorDirective {
  static ngTemplateContextGuard(directive, context) {
    return true;
  }
  set totalElements(value) {
    this.calculateNewState({
      newTotalElements: value,
      newPage: 0
    });
  }
...
_BrnPaginatorDirective.ɵfac = function BrnPaginatorDirective_Factory(t) {
  return new (t || _BrnPaginatorDirective)();
};
_BrnPaginatorDirective.ɵdir = ɵɵdefineDirective({
  type: _BrnPaginatorDirective,
  selectors: [["", "brnPaginator", ""]],
  inputs: {
    totalElements: [InputFlags.None, "brnPaginatorTotalElements", "totalElements"],
    currentPage: [InputFlags.HasDecoratorInputTransform, "brnPaginatorCurrentPage", "currentPage", numberAttribute],
    pageSize: [InputFlags.HasDecoratorInputTransform, "brnPaginatorPageSize", "pageSize", numberAttribute],
    onStateChange: [InputFlags.None, "brnPaginatorOnStateChange", "onStateChange"]
  },
  exportAs: ["brnPaginator"],
  standalone: true,
  features: [ɵɵInputTransformsFeature]
});
var BrnPaginatorDirective = _BrnPaginatorDirective;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BrnPaginatorDirective, [{
    type: Directive,
    args: [{
      standalone: true,
    ...
    totalElements: [{
      type: Input,
      args: [{
        alias: "brnPaginatorTotalElements"
      }]
    }],
    currentPage: [{
      type: Input,
      args: [{
        alias: "brnPaginatorCurrentPage",
    ...
    onStateChange: [{
      type: Input,
      args: [{
        alias: "brnPaginatorOnStateChange"
      }]
    }]
  });
})();
var _BrnTableComponent = class _BrnTableComponent {
  constructor() {
    this.dataSource = [];
...
_BrnTableComponent.ɵfac = function BrnTableComponent_Factory(t) {
  return new (t || _BrnTableComponent)();
};
_BrnTableComponent.ɵcmp = ɵɵdefineComponent({
  type: _BrnTableComponent,
  selectors: [["brn-table"]],
  contentQueries: function BrnTableComponent_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ɵɵcontentQuery(dirIndex, BrnColumnDefComponent, 4);
      ɵɵcontentQuery(dirIndex, CdkRowDef, 4);
    }
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.columnDefComponents = _t);
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.rowDefs = _t);
    }
  },
  viewQuery: function BrnTableComponent_Query(rf, ctx) {
    if (rf & 1) {
      ɵɵviewQuery(_c2, 7, CdkTable);
    }
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx._cdkTable = _t.first);
    }
  },
  inputs: {
    dataSource: "dataSource",
    ...
    trackBy: "trackBy",
    customTemplateDataRows: [InputFlags.HasDecoratorInputTransform, "customTemplateDataRows", "customTemplateDataRows", booleanAttribute],
    onRowClick: "onRowClick",
    stickyHeader: [InputFlags.HasDecoratorInputTransform, "stickyHeader", "stickyHeader", booleanAttribute],
  ...
  standalone: true,
  features: [ɵɵProvidersFeature([provideTableClassesSettableExisting(() => _BrnTableComponent)]), ɵɵInputTransformsFeature, ɵɵStandaloneFeature],
  ngContentSelectors: _c4,
  decls: 6,
  vars: 8,
  consts: [["cdkTable", ""], [3, "contentChanged", "dataSource", "fixedLayout", "multiTemplateDataRows"], [3, "class", 4, "cdkHeaderRowDef", "cdkHeaderRowDefSticky"], [3, "tabindex", "row-interactive", "class"], ["cdkNoDataRow", ""], [3, "tabindex", "row-interactive", "class", "keydown.enter", "click", 4, "cdkRowDef", "cdkRowDefColumns"], [3, "keydown.enter", "click", "tabindex"]],
  template: function BrnTableComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = ɵɵgetCurrentView();
      ɵɵprojectionDef(_c3);
      ɵɵelementStart(0, "cdk-table", 1, 0);
      ɵɵlistener("contentChanged", function BrnTableComponent_Template_cdk_table_contentChanged_0_listener() {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.contentChanged.emit());
      });
      ɵɵprojection(2);
      ɵɵtemplate(3, BrnTableComponent_cdk_header_row_3_Template, 1, 2, "cdk-header-row", 2)(4, BrnTableComponent_Conditional_4_Template, 1, 1, "cdk-row", 3)(5, BrnTableComponent_ng_template_5_Template, 1, 0, "ng-template", 4);
      ɵɵelementEnd();
    }
    if (rf & 2) {
      ɵɵclassMap(ctx.tableClasses);
      ɵɵproperty("dataSource", ctx.dataSource)("fixedLayout", ctx.fixedLayout)("multiTemplateDataRows", ctx.multiTemplateDataRows);
      ɵɵadvance(3);
      ɵɵproperty("cdkHeaderRowDef", ctx.displayedColumns)("cdkHeaderRowDefSticky", ctx.stickyHeader);
      ɵɵadvance();
      ɵɵconditional(4, !ctx.customTemplateDataRows ? 4 : -1);
    }
  },
  dependencies: [CdkTableModule, CdkTable, CdkRowDef, CdkRow, CdkHeaderRow, CdkHeaderRowDef, CdkNoDataRow],
  encapsulation: 2,
  changeDetection: 0
});
var BrnTableComponent = _BrnTableComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BrnTableComponent, [{
    type: Component,
    args: [{
      selector: "brn-table",
      standalone: true,
...
var BrnColumnManager = class {
  constructor(initialColumnVisibility) {
    this.displayedColumns = computed(() => {
      return Object.entries(this._columnVisibility()).filter(([, value]) => typeof value === "boolean" ? value : value.visible).map(([key]) => key);
    });
  ...
  toggleVisibility(columnName) {
    ...
    const columnEntry = visibilityMap[columnName];
    const newVisibilityState = typeof columnEntry === "boolean" ? !columnEntry : {
      visible: !columnEntry.visible
    };
    this._columnVisibility.set(__spreadProps(__spreadValues({}, visibilityMap), {
      [columnName]: newVisibilityState
    }));
  }
  setVisible(columnName) {
    const visibilityMap = this._columnVisibility();
    const columnEntry = visibilityMap[columnName];
    const newVisibilityState = typeof columnEntry === "boolean" ? true : {
      visible: true
    };
    this._columnVisibility.set(__spreadProps(__spreadValues({}, visibilityMap), {
      [columnName]: newVisibilityState
  ...
  setInvisible(columnName) {
    const visibilityMap = this._columnVisibility();
    const columnEntry = visibilityMap[columnName];
    const newVisibilityState = typeof columnEntry === "boolean" ? false : {
      visible: false
    };
    this._columnVisibility.set(__spreadProps(__spreadValues({}, visibilityMap), {
      [columnName]: newVisibilityState
...
var useBrnColumnManager = (initialColumnVisibility) => new BrnColumnManager(initialColumnVisibility);
var BrnTableImports = [BrnCellDefDirective, BrnColumnDefComponent, BrnFooterDefDirective, BrnHeaderDefDirective, BrnTableComponent, BrnPaginatorDirective];
var _BrnTableModule = class _BrnTableModule {
};
_BrnTableModule.ɵfac = function BrnTableModule_Factory(t) {
  return new (t || _BrnTableModule)();
};
_BrnTableModule.ɵmod = ɵɵdefineNgModule({
  type: _BrnTableModule,
  imports: [BrnCellDefDirective, BrnColumnDefComponent, BrnFooterDefDirective, BrnHeaderDefDirective, BrnTableComponent, BrnPaginatorDirective],
  exports: [BrnCellDefDirective, BrnColumnDefComponent, BrnFooterDefDirective, BrnHeaderDefDirective, BrnTableComponent, BrnPaginatorDirective]
});
_BrnTableModule.ɵinj = ɵɵdefineInjector({
  imports: [BrnColumnDefComponent, BrnTableComponent]
});
var BrnTableModule = _BrnTableModule;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BrnTableModule, [{
    type: NgModule,
    args: [{
...
//# sourceMappingURL=@spartan-ng_ui-table-brain.js.map
